...
class CollaborativeFiltering:
    ...
    def __init__(self, df_ustd):
        self.df_std = df_ustd.apply(lambda x: C(x).Standardize()).T #Chuẩn hóa giá trị của từng dòng
        self.df = df_ustd
    def Calculate(self):
...
user = [("0002005018",1),("0060973129",1)]

CF = CollaborativeFiltering(user_book_rating[:size_Train]);
CF.Calculate();
print(user)
print('Dự đoán')
print('---------------------------')
